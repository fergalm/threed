...
class Camera():
    ...
    def renderShape(self, obj:Sprite):
        ...
        ang2 = tpoints[:, [2,1]]
        # pixels = self.transform_to_device_coords(ang)
        ...
        for i in range(len(facets)):
            ...
            mark_centroids(corners, zdist[j], clr)
...
def wireframe(vertices, clr):
    """Plot object in wireframe
    
    Inputs
    ----------
    vertices
        (3x2 numpy array) of image plane angular
...
def mark_centroids(vertices, zdist, clr):
